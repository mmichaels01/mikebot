#!/usr/bin/python
# 1.11.15 From http://www.bytecreation.com/blog/2013/10/13/raspberry-pi-ultrasonic-sensor-hc-sr04

# This one suggests a 1K resistor between Echo and the input GPIO port
